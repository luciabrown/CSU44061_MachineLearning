...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Question A - Part I - Plotting the Source Data")
plt.legend()
plt.grid(False)
plt.show()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Question A - Part III - Plotting Predictions of a Logistical Regression Classifier")
...
ax.scatter(X1[y==1], X2[y==1], marker="+", color="lime", label="Target = +1")
ax.scatter(X1[y==-1], X2[y==-1], marker="o", color="blue", label="Target = -1")
ax.scatter(X1_test_SVM[(y_test_SVM == y_pred_Zero) & (y_test_SVM == 1)], X2_test_SVM[(y_test_SVM == y_pred_Zero) & (y_test_SVM == 1)],facecolors='none', edgecolors='orange', s=100, label="Predicted +1")
ax.scatter(X1_test_SVM[(y_test_SVM == y_pred_Zero) & (y_test_SVM == -1)], X2_test_SVM[(y_test_SVM == y_pred_Zero) & (y_test_SVM == -1)],facecolors='none', edgecolors='darkorange', s=100, label="Predicted -1")
ax.plot(x_vals, y_vals_Zero, color='black', linewidth=1.5, label="Decision Boundary")
ax.set_xlabel("X1")
ax.set_ylabel("X2")
ax.set_title("Question B - Part III Where C=0.001")
ax.legend(loc="upper center", bbox_to_anchor=(0.5, -0.15), ncol=2, fontsize=8,markerscale=0.8,)
ax.grid(False)
...
ax.scatter(X1[y==1], X2[y==1], marker="+", color="lime", label="Target = +1")
ax.scatter(X1[y==-1], X2[y==-1], marker="o", color="blue", label="Target = -1")
ax.scatter(X1_test_SVM[(y_test_SVM == y_pred_One) & (y_test_SVM == 1)], X2_test_SVM[(y_test_SVM == y_pred_One) & (y_test_SVM == 1)],facecolors='none', edgecolors='gold', s=100, label="Predicted +1")
ax.scatter(X1_test_SVM[(y_test_SVM == y_pred_One) & (y_test_SVM == -1)], X2_test_SVM[(y_test_SVM == y_pred_One) & (y_test_SVM == -1)],facecolors='none', edgecolors='yellow', s=100, label="Predicted -1")
ax.plot(x_vals, y_vals_One, color='black', linewidth=1.5, label="Decision Boundary")
ax.set_xlabel("X1")
ax.set_ylabel("X2")
ax.set_title("Question B - Part III Where C=1")
ax.legend(loc="upper center", bbox_to_anchor=(0.5, -0.15), ncol=2, fontsize=8,markerscale=0.8,)
ax.grid(False)
...
ax.scatter(X1[y==1], X2[y==1], marker="+", color="lime", label="Target = +1")
ax.scatter(X1[y==-1], X2[y==-1], marker="o", color="blue", label="Target = -1")
ax.scatter(X1_test_SVM[(y_test_SVM == y_pred_Hundred) & (y_test_SVM == 1)], X2_test_SVM[(y_test_SVM == y_pred_Hundred) & (y_test_SVM == 1)],facecolors='none', edgecolors='brown', s=100, label="Predicted +1")
ax.scatter(X1_test_SVM[(y_test_SVM == y_pred_Hundred) & (y_test_SVM == -1)], X2_test_SVM[(y_test_SVM == y_pred_Hundred) & (y_test_SVM == -1)],facecolors='none', edgecolors='fuchsia', s=100, label="Predicted -1")
ax.plot(x_vals, y_vals_Hundred, color='black', linewidth=1.5, label="Decision Boundary")
ax.set_xlabel("X1")
ax.set_ylabel("X2")
ax.set_title("Question B - Part III Where C=100")
ax.legend(loc="upper center", bbox_to_anchor=(0.5, -0.15), ncol=2, fontsize=8,markerscale=0.8,)
